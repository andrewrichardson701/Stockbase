...
class TransactionModel extends Model
{
    ...
    static public function getTransactionsList($type = null, $stock_id=null, $is_cable=0, $limit, $offset)
    {
        ...
        if ($type == null || $type == 'stock' || $type == 'cables') {
            ...
            $instance->setTable('cpu_transaction as t');
            $query = $instance->select(
                                        ['t.id as id',
                                        't.table_name as table_name',
                                        't.item_id AS item_id',
    ...
    {
        $insert = DB::table('cable_transaction')->insertGetId($request);
        $id = $insert;
    ...
    static public function addCpuTransaction($request)
    {
        $insert = DB::table('cpu_transaction')->insertGetId($request);
        $id = $insert;
