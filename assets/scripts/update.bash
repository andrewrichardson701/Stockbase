...
REMOTE_REPO="https://gitlab.com/andrewrichardson701/stockbase.git"
...
sleep 1
git clone --branch $selected_branch https://gitlab.com/andrewrichardson701/stockbase.git $tmp_dir
echo "Done."
sleep 1
