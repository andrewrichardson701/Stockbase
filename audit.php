    ...
    <div class="content">
        ...
        if (!$siteCount > 0 || !$areaCount > 0 || !$shelfCount > 0) {
            ...
            echo('
                <div class="container" id="search-fields" style="max-width:max-content;margin-bottom:10px; margin-top:20px">
                    <div class="nav-row">
                        ...
                        <div id="zero-div" class="nav-div viewport-large-block" style="margin-left:15px;margin-right:0px;margin-bottom:10px;" hidden>');
                        if ($showOOS == 0) {
            ...
            <div style="margin-left:5%;margin-right:5%;max-width:90%">
                ...
                <p class="" style="padding-left:20px;padding-bottom:10px; margin:0px">Date: <or class="green">'.$date.'</or></p>
                </div>
