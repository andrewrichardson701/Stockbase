...
class CreateUsersPermissionsRolesTable extends Migration
{
    public function up()
    {
        Schema::create('users_permissions_roles', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('users_permissions_roles');
    }
}
