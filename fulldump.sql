...
INSERT INTO `config` VALUES (1,'#72BE2A','custom/160923231839-cdc-favicon.png','custom/160923231839-cdc-favicon.png',1,'ldapauth','RHJvcHNCdWlsZHNTa2lsbDEyISE=','ajrich.co.uk','10.0.2.5',389,'DC=ajrich,DC=co,DC=uk','cn=Users','(objectClass=User)','£','STOCK-','mail.ajrich.co.uk',587,'starttls','RGVtb1Bhc3MxIQ==','inventory@ajrich.co.uk','Inventory System','inventory@ajrich.co.uk','inventory@ajrich.co.uk','Inventory System','10.0.2.6','inventory.ajrich.co.uk',1);
...
INSERT INTO `users` VALUES (0,'root','root','root','root@inventory.local','local','$2y$10$AH3rVs9iStQICTei0peKhO.BHIkS8FuqjcaWxcupiyIUJWgRSqIa.',0,1,0,0),(1,'andrew1','Andrew','Richardson','andrew@ajrich.co.uk','ldap',NULL,1,1,0,0),(2,'inventory','Inventory','User','inventory@ajrich.co.uk','ldap',NULL,2,1,0,0),(3,'Spam','Spam','Account','Spam@ajrich.co.uk','ldap',NULL,1,1,0,0),(4,'testlocal','test','local','spam@ajrich.co.uk','local','$2y$10$E8Agy4bN/CwTNC1w/j1xcuQSNBMWRvCLLRkScrHt3zSdBTmlYTBgO',1,1,0,0),(5,'example','example','user','example@example.com','local','$2y$10$HZBchNa34DE6T/cLsfko2eow.55AWDvf5ojUswPPBvOrx8E..ONne',1,0,1,0);
...
-- Dump completed on 2023-09-17  2:13:16
