...
function addQuantity($stock_id, $cable_item_id) {
    ...
    if ($cable_item_id == $item['id']) {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            $email_subject = "Cable Stock Added";
            $email_body = "<p>Cable stock added, for <strong><a href=\"https://$current_base_url/stock.php?stock_id=".$stock_info['id']."\">".$stock_info['name']."</a></strong> in <strong>".$item_location['site_name']."</strong>, <strong>".$item_location['area_name']."</strong>, <strong>".$item_location['shelf_name']."</strong>!<br>New stock count: <strong>$new_quantity</strong>.</p>";
    ...
    if ($quantity > 0) {
        ...
        if ($cable_item_id == $item['id']) { 
            ...
            if (!mysqli_stmt_prepare($stmt, $sql)) {
                ...
                $email_subject = "Cable Stock Removed";
                $email_body = "<p>Cable stock removed, from <strong><a href=\"https://$current_base_url/stock.php?stock_id=".$stock_info['id']."\">".$stock_info['name']."</a></strong> in <strong>".$item_location['site_name']."</strong>, <strong>".$item_location['area_name']."</strong>, <strong>".$item_location['shelf_name']."</strong>!<br>New stock count: <strong>$new_quantity</strong>.</p>";
                ...
                if ($new_quantity < $stock_info['min_stock']) {
                    $email_subject = "Cable Stock Below Minimum Stock Count at ".$item_location['site_name'].". Please Order More!";
                    $email_body = "<p>Cable stock below minimum stock count, for <strong><a href=\"https://$current_base_url/stock.php?stock_id=".$stock_info['id']."\">".$stock_info['name']."</a></strong> in <strong>".$item_location['site_name']."</strong>, <strong>".$item_location['area_name']."</strong>, <strong>".$item_location['shelf_name']."</strong>!<br>New stock count: <strong>$new_quantity</strong>.</p><p style='color:red'>Please raise a PO to order more!</p>";
            
                    send_email($loggedin_email, $loggedin_fullname, $config_smtp_from_name, $email_subject, createEmail($email_body), 14);
                    send_email($current_smtp_to_email, $loggedin_fullname, $config_smtp_from_name, $email_subject, createEmail($email_body), 14);
                }
                ...
                if ($rowCount_stock > 0) {
                    ...
                    if (!mysqli_stmt_prepare($stmt_sku, $sql_sku)) {
                        ...
                        if (!mysqli_stmt_prepare($stmt_add, $sql_add)) {
                            ...
                            $email_subject = "Cable Stock Created";
                            $email_body = "<p>Cable stock created:<strong><a href=\"https://$current_base_url/stock.php?stock_id=".$stock_info['id']."\">".$stock_info['name']."</a></strong>.</p>";
                            send_email($loggedin_email, $loggedin_fullname, $config_smtp_from_name, $email_subject, createEmail($email_body), 8);
