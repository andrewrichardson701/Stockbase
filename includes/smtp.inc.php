...
$email_template_end = '
        ...
        <div style="padding-top:10px; padding-bottom:20px;text-align: center;">
            <p style="font-size:14px; color: '.$comp_banner_color.'">Copyright &copy; '.date("Y").' <a href="https://github.com/andrewrichardson701/Stockbase" style="color:'.$comp_url_color.' !important">StockBase</a>. All rights reserved.</p>
        </div>
    </div>';
