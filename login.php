                ...
                <form id="loginForm" style="margin-bottom:0px">
                    ...
                    <div class="form-group">
                        ...
                        <div id="password-div" style="position:relative">
                            ...
                            <i class="fa fa-eye" id="password-eye" style="color: black; position:absolute; right:20px;top:12px; cursor: pointer" onclick="togglePassword(this)" title="Toggle password visibility."></i>
                        </div>
                    </div>
