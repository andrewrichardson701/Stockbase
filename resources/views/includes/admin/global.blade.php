<div class="container-fluid" style="padding-bottom:0px">
    <h3 class="clickable" style="font-size:22px" id="global-settings">Global Settings</h3>
    <!-- Global Settings -->
    <div class="adminContent" id="global">
        ...
        <form id="globalForm" enctype="multipart/form-data" action="{{ route('admin.globalSettings') }}" method="POST">
            ...
            <table id="globalTable">
                <tbody>
                    ...
                    <tr class="">
                        <td class="align-middle" id="system_name-label" style="width:250px;margin-left:25px;padding-bottom:20px">
                            <p style="min-height:max-content;margin:0px" class=" align-middle" for="system_name">System Name:</p>
                        </td>
                        <td class="align-middle" id="system_name-set" style="width:250px;padding-bottom:20px">
                            <input class="form-control theme-input-alt" type="text" style="width: 150px" id="system_name" name="system_name">
                        </td>
                        <td class="align-middle" style="min-width:230px;margin-left:10px; padding-left:15px;padding-bottom:20px">
                            <label class=""><span class="uni">{{ $head_data['config']['system_name'] }}</span></label>
                        </td>
                        <td class="align-middle" style="min-width:230px;margin-left:25px; padding-left:15px;padding-bottom:20px">
                            <label class=""><span class="uni">{{ $head_data['default_config']['system_name'] }}</span></label>
                        </td>
                    </tr>
                    <tr class="" id="banner-color" style="margin-top:20px">
                        <td class="align-middle" id="banner-color-label" style="width:250px;margin-left:25px;padding-bottom:20px">
                            <!-- Custodian Colour: #72BE2A -->
                            <p style="min-height:max-content;margin:0px" class=" align-middle" for="banner_color">Banner Colour:</p>
                        </td>
                        <td class="align-middle" id="banner-color-picker" style="width:250px;padding-bottom:20px">
                        ...
                        <td class="align-middle" style="min-width:230px;padding-left:15px;padding-bottom:20px">
                    ...
                    <tr class="" style="margin-top:20px" id="banner-logo">
                        <td class="align-middle" id="banner-logo-label" style="width:250px;margin-left:25px;padding-bottom:20px;padding-bottom:20px">
                            <p style="min-height:max-content;margin:0px" class=" align-middle" for="logo_image">Banner Logo:</p>
                        </td>
                        <td class="align-middle" id="banner-logo-file">
                            <input class="" type="file" style="width: 250px;padding-bottom:20px" id="logo_image" name="logo_image">
                        </td>
                        <td class="align-middle" style="min-width:230px;margin-left:25px;padding-bottom:20px;padding-left:15px">
                            <label class=""><img class="thumb" src="{{ asset('img/config/'.$head_data['config']['logo_image']) }}" style="width:50px" onclick="modalLoad(this)" /></label>
                        </td>
                        <td class="align-middle" style="min-width:230px;margin-left:25px;padding-bottom:20px;padding-left:15px">
                            <label class=""><img class="thumb" src="{{ asset('img/config/'.$head_data['default_config']['logo_image']) }}" style="width:50px" onclick="modalLoad(this)" /></label>
                        </td>
                    </tr>
                    <tr class="" style="margin-top:20px" id="favicon-image">
                        <td class="align-middle" id="favicon-image-label" style="width:250px;margin-left:25px;padding-bottom:20px">
                            <p style="min-height:max-content;margin:0px" class=" align-middle" for="favicon_image">Favicon Image:</p>
                        </td>
                        <td class="align-middle" id="favicon-image-file" style="padding-bottom:20px">
                            <input class="" type="file" style="width: 250px" id="favicon_image" name="favicon_image">
                        </td>
                        <td class="align-middle" style="min-width:230px;margin-left:25px;padding-bottom:20px;padding-left:15px">
                            <label class=""><img class="thumb" src="{{ asset('img/config/'.$head_data['config']['favicon_image']) }}" style="width:32px" onclick="modalLoad(this)" /></label>
                        </td>
                        <td class="align-middle" style="min-width:230px;margin-left:25px;padding-bottom:20px;padding-left:15px">
                            <label class=""><img class="thumb" src="{{ asset('img/config/'.$head_data['default_config']['favicon_image']) }}" style="width:32px" onclick="modalLoad(this)" /></label>
                        </td>
                    </tr>
                    <tr class="" style="margin-top:20px">
                        <td class="align-middle" id="currency-selector-label" style="width:250px;margin-left:25px;padding-bottom:20px">
                            <p style="min-height:max-content;margin:0px" class=" align-middle" for="currency_selection">Currency:</p>
                        </td>
                        <td class="align-middle" id="currency-selector" style="width:250px;padding-bottom:20px">
                    ...
                    <tr class="" style="margin-top:20px">
                        <td class="align-middle" id="sku-prefix-label" style="width:250px;margin-left:25px;padding-bottom:20px">
                        ...
                        <td class="align-middle" id="sku-prefix-set" style="width:250px;padding-bottom:20px">
                    ...
                    <tr class="" style="margin-top:20px">
                        <td class="align-middle" id="base-url-label" style="width:250px;margin-left:25px;padding-bottom:20px">
                        ...
                        <td class="align-middle" id="base-url-set" style="width:250px;padding-bottom:20px">
                    ...
                    <tr class="" style="margin-top:20px">
                        <td class="align-middle" id="default-theme-label" style="width:250px;margin-left:25px;padding-bottom:20px">
                            <p style="min-height:max-content;margin:0px" class=" align-middle" for="default_theme_id">Default Theme:</p>
                        </td>
                        <td class="align-middle" id="default-theme-set" style="width:250px;padding-bottom:20px">
                        ...
                        <td class="align-middle" style="min-width:230px;margin-left:25px; padding-left:15px;padding-bottom:20px">
                            <label class=""><span class="uni">{{ $head_data['default_theme']['name'] }}</span></label>
                        </td>
                        <td class="align-middle" style="min-width:230px;margin-left:25px; padding-left:15px;padding-bottom:20px">
                            <label class=""><span class="uni">{{ $head_data['default_theme_default']['name'] }}</span></label>
                        </td>
                    </tr>
