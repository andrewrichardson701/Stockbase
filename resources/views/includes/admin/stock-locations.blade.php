                    ...
                    @foreach ($sites['rows'] as $site)
                        ...
                        @endif
                            ...
                            <form id="siteForm-delete-{{ $site['id'] }}" enctype="multipart/form-data" action="./includes/admin.inc.php" method="POST">
                                ...
                                <td class="stockTD theme-table-blank">
                                @if ($site['deleted'] != 1)
                                    <button class="btn btn-danger cw nav-v-b" style="padding: 3px 6px 3px 6px;font-size: 12px" name="location-delete-submit" value="site" type="submit" @if (($site_links[$site['id']]['count'] ?? 0) !== 0) disabled title="Dependencies exist for this object." @else title="Delete object" @endif >
