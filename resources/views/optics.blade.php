                ...
                <form id="add-optic-form" action="{{ route('optics.add') }}" method="POST" enctype="multipart/form-data" style="margin-bottom:0px">
                    ...
                    <div class="row" style="margin-right:25px;margin-top:5px">
                        ...
                        <div class="col">
                            <div>Vendor</div>
                            <div>
                                <select id="optic_vendor-select" name="vendor" class="form-control text-center theme-dropdown" style="border-color:black;" required>
                                @if ($optic_vendors['count'] > 0)
                        ...
                        <div class="col">
                            <div>Type</div>
                            <div>
                                <select id="optic_type-select" name="type" class="form-control text-center theme-dropdown" style="border-color:black;" required>
                                @if ($optic_types['count'] > 0)
                    ...
                    <div class="row" style="margin-right:25px">
                        <div class="col">
                            <div>Speed</div>
                            <div>
                                <select id="optic_speed-select" name="speed" class="form-control text-center theme-dropdown" style="border-color:black;" required>
                                @if ($optic_speeds['count'] > 0)
                        ...
                        <div class="col">
                            <div>Connector</div>
                            <div>
                                <select id="optic_connector-select" name="connector" class="form-control text-center theme-dropdown" style="border-color:black;" required>
                                @if ($optic_connectors['count'] > 0)
                        ...
                        <div class="col">
                            <div>Distance</div>
                            <div>
                                <select id="optic_distance-select" name="distance" class="form-control text-center theme-dropdown" style="border-color:black;" required>
                                @if ($optic_distances['count'] > 0)
                    ...
                    <div class="row align-middle" style="margin-right:25px">
                        ...
                        <div class="col" style="margin-top:10px">
                            ...
                            <button id="optic-add-multiple" class="btn btn-success align-bottom" type="submit" name="add-optic-submit-multiple" style="margin-left:20px" value="2">Add Multiple</button>
                        </div>
