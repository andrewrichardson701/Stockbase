                                            ...
                                            @foreach ($stock_item_data['rows'] as $item)
                                                @if ($item['manufacturer_id'] == $row['manufacturer_id'] &&
                                                    ...
                                                    <tr class="align-middle">
                                                        ...
                                                        <td class="align-middle text-center"><input type="text" form="form-item-{{ $item['item_id'] }}" class="form-control" style="" value="{{ htmlspecialchars($item['comments'], ENT_QUOTES, 'UTF-8') }}" name="comments" /></td>
