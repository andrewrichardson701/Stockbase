                    ...
                    <table class="centertable" style="margin-bottom:20px">
                        <thead>
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="theme" id="theme-select" style="padding-left:10px;padding-right:40px" onchange="changeTheme()">
                                    @if($themes['count'] > 0 && !empty($themes['rows']))
                                        @foreach($themes['rows'] as $theme)
                                        <option id="theme-select-option-{{ $theme['id'] }}" title="{{ $theme['file_name'] }}" alt="{{ $theme['name'] }}" value="{{ $theme['id'] }}" @if($head_data['user']['theme_id'] == $theme['id']) selected @endif>{{ $theme['name'] }}</option>
                                        @endforeach
                                    @else
                                        <option value='' selected disables>No theme found...</option></option>
                                    @endif
                                    </select>
                                </td>
                            </tr>
                        ...
                        <tbody>
                            <tr class="text-center">
                                <td id="css" class="align-top" rowspan=100%>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="tag-color">
                                                        <input class="form-control input-color color" placeholder="#XXXXXX" data-value="#xxxxxx" value="{{ $head_data['config_compare']['banner_color'] }}"/>
                                                    </label>
                                                </td>
                                            <tr>
                                        </tbody>
                                    ...
                                    <form enctype="multipart/form-data" action="{{ route('theme-testing.uploadTheme') }}" method="POST">
                                                ...
                                                <tr class="vertical-align align-middle highlight" id="1">
                                                    ...
                                                    <td class="align-middle" id="1-img-td">
                                                        <img id="1-img" class="inv-img-main thumb"
                                                            src="{{ asset('img/config/'. $head_data['config_compare']['logo_image']) }}" alt="Cisco C3650X">
                                                    </td>
                                            ...
                                            <table class="table table-dark theme-table centertable" id="inventoryTable">
                                                ...
                                                <tbody class="align-middle" style="text-align: center; white-space: nowrap;">
                                                    <tr class="vertical-align align-middle" id="41">
                                                            ...
                                                            <img id="41-img" class="inv-img-50h thumb" src="{{ asset('img/config/'. $head_data['config_compare']['logo_image']) }}"  alt="Cat5e Black 1m"></td>
                                                    ...
                                                    <tr class="vertical-align align-middle" id="42">
                                                            ...
                                                            <img id="42-img" class="inv-img-50h thumb" src="{{ asset('img/config/'. $head_data['config_compare']['logo_image']) }}"  alt="Cat5e Black 2m"></td>
                                                ...
                                                <div class="col-sm-4 text-right" style="margin-left:70px" id="stock-info-right"><div class="well-nopad theme-divBg nav-right" style="margin:20px;padding:0px;width:max-content">
                                                    <div class="nav-row" style="width:315px">
                                                            <div class="thumb theme-divBg-m text-center" style="width:235px;height:235px">
                                                                <img class="nav-v-c" id="stock-1-img-1" style="max-width:235px; max-height:235px" alt="Cisco C3650X - image 1" src="{{ asset('img/config/'. $head_data['config_compare']['logo_image']) }}">
                                                            </div>
                                                            <span id="side-images" style="margin-left:5px">
                                                            
                                                            <div class="thumb theme-divBg-m" style="width:75px;height:75px;margin-bottom:5px">
                                                                <img class="nav-v-c" id="stock-1-img-2" style="width:75px" alt="Cisco C3650X - image 2" src="{{ asset('img/config/'. $head_data['config_compare']['logo_image']) }}">
                                                            </div>
                                                            <span></span></span></div>
                                                    </div>
                                                </div>
